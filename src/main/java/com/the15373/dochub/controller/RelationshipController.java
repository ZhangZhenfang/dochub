...
public class RelationshipController {
    ...
    public AbstractResponse  getRelationship(HttpServletRequest request) {
		try {
			...
			List<UserDto> list= relationshipService.getByUserid(user.getUserid());
	...
	try {
		...
		User user=(User)request.getSession().getAttribute("user");
	    User friend=userService.getByAccount(account);
	    if(friend!=null)
	    {
	...
	public Map<String, String> deleRelationship(String account, HttpServletRequest request) {
		...
		try {
			...
			User user=(User)request.getSession().getAttribute("user");
			User friend=userService.getByAccount(account);
			Relationship relation= relationshipService.getRelationship(user,friend.getUserid());
